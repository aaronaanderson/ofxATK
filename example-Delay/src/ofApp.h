...
//need something to delay, lets use a simple grain stream
...
class ofApp : public ofBaseApp{
    ...
    SmoothValue delayTimeSV;//changes in delaytime should be audio rate and continuous
    //some source to delay
